...
echo "${exe_path}/minotari_base_node" --config="${config_path}/config.toml" --log_config="${config_path}/log4rs_base_node.yml" --base-path="${base_path}" > $exe_path/minotari_base_node_command.sh
chmod +x $exe_path/minotari_base_node_command.sh

open -a terminal $exe_path/minotari_base_node_command.sh
echo
