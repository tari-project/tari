...
impl NodePromptRegistry {
    ...
    pub fn new() -> PromptRegistry {
        ...
        registry.register(simple_prompt!(
            ...
            vec![
                text_message(MessageRole::System, "You are helping assess the health of a Tari base node. Provide a comprehensive status check."),
                text_message(MessageRole::User, "Please provide a complete health assessment of this Tari base node. Check the following:
...
Use the available resources to gather this information and provide a clear summary."),
        ...
        registry.register(simple_prompt!(
            ...
            vec![
                text_message(MessageRole::System, "You are helping set up mining operations for a Tari base node."),
                text_message(MessageRole::User, "I want to set up mining with this Tari base node. Please provide:
...
Use the available tools and resources to provide practical guidance."),
        ...
        registry.register(simple_prompt!(
            ...
            vec![
                text_message(MessageRole::System, "You are helping diagnose network connectivity issues for a Tari base node."),
                text_message(MessageRole::User, "I'm having network connectivity issues with my Tari base node. Please help diagnose:
...
Analyze the current state and provide actionable recommendations."),
        ...
        registry.register(simple_prompt!(
            ...
            vec![
                text_message(MessageRole::System, "You are helping troubleshoot blockchain synchronization issues for a Tari base node."),
                text_message(MessageRole::User, "My Tari base node seems to have synchronization issues. Please help troubleshoot:
