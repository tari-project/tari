# Minotari Ledger Nano S Plus Installer (macOS)

This script installs the **Minotari Ledger Wallet app** (`minotari_ledger_wallet-nanosplus`) onto a **Ledger Nano S Plus** on macOS.
...
5. Downloads the **latest** `minotari_ledger_wallet-nanosplus` release from GitHub
