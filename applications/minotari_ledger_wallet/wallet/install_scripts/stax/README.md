# Minotari Ledger Stax Installer (macOS)

This script installs the **Minotari Ledger Wallet app** (`minotari_ledger_wallet-stax`) onto a **Ledger Stax** on macOS.
