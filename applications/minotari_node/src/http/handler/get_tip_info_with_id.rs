...
use log::debug;
use tari_core::{
    base_node::rpc::{models::TipInfoResponseWithId, query_service, BaseNodeWalletQueryService},
...
const LOG_TARGET: &str = "c::base_node::rpc::http::handler::get_tip_info_with_id";
...
#[utoipa::path(
    ...
    path = "/get_tip_info",
    responses(
        (status = 200, description = "Tip info with id returned successfully", body = TipInfoResponseWithId),
