...
:NO_MINING
echo No mining
start cmd /k "%my_exe_path%\start_minotari_node.bat"
ping -n 7 localhost>nul
start cmd /k "%my_exe_path%\start_minotari_console_wallet.bat"
goto :end
...
start cmd /k "%my_exe_path%\start_minotari_console_wallet.bat"
ping -n 7 localhost>nul
start cmd /k "%my_exe_path%\start_minotari_miner.bat"
goto :end
...
start cmd /k "%my_exe_path%\start_minotari_console_wallet.bat"
ping -n 7 localhost>nul
start cmd /k "%my_exe_path%\start_minotari_merge_mining_proxy.bat"
ping -n 7 localhost>nul
