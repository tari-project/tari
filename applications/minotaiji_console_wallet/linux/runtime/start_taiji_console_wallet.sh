...
echo
gnome-terminal --working-directory="$PWD" -- "${exe_path}/minotaiji_console_wallet" ${init_flag} --config "${config_path}/config.toml" --log_config "${config_path}/log4rs_console_wallet.yml" --base-path ${base_path}
