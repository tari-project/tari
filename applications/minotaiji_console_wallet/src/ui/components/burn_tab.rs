        ...
        if self.confirmation_dialog.is_some() {
            if 'n' == c {
                ...
                if 'y' == c {
                    let amount = self
                        .amount_field
                        .parse::<MicroMinotaiji>()
                        .unwrap_or_else(|_| MicroMinotaiji::from(0));
        ...
        match self.confirmation_dialog {
            ...
            Some(BurnConfirmationDialogType::Normal) => {
                draw_dialog(
                    ...
                    format!(
                        "Are you sure you want to burn {} Minotaiji with a Claim Public Key {}?\n(Y)es / (N)o",
    ...
    fn on_key(&mut self, app_state: &mut AppState, c: char) {
        ...
        match c {
            ...
            's' => {
                ...
                if self.amount_field.parse::<MicroMinotaiji>().is_err() {
                    self.error_message =
