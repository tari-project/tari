...
:NO_MINING
echo No mining
start cmd /k "%my_exe_path%\start_minotaiji_node.bat"
ping -n 7 localhost>nul
start cmd /k "%my_exe_path%\start_minotaiji_console_wallet.bat"
goto :end
...
start cmd /k "%my_exe_path%\start_minotaiji_console_wallet.bat"
ping -n 7 localhost>nul
start cmd /k "%my_exe_path%\start_minotaiji_miner.bat"
goto :end
...
start cmd /k "%my_exe_path%\start_minotaiji_console_wallet.bat"
ping -n 7 localhost>nul
start cmd /k "%my_exe_path%\start_minotaiji_merge_mining_proxy.bat"
ping -n 7 localhost>nul
