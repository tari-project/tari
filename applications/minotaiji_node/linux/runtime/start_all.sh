...
call_base_node() {
    "${exe_path}/start_minotaiji_node.sh"
}

call_console_wallet() {
    "${exe_path}/start_minotaiji_console_wallet.sh"
}

call_mining() {
    "${exe_path}/start_minotaiji_miner.sh"
}

call_merge_mining_proxy() {
    "${exe_path}/start_minotaiji_merge_mining_proxy.sh"
}
