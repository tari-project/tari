...
echo "${exe_path}/tari_base_node" --config="${config_path}/config.toml" --log_config="${config_path}/log4rs_base_node.yml" --base-path="${base_path}" > "${exe_path}/start_tari_base_node.sh"
chmod +x "${exe_path}/start_tari_base_node.sh"

open -a terminal "${exe_path}/start_tari_base_node.sh"
echo
