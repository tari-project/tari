...
fn set_transport_defaults(cfg: &mut Config) -> Result<(), config::ConfigError> {
    ...
    for app in apps {
        ...
        cfg.set_default(
            &format!("{}.mainnet.tcp_listener_address", app),
        ...
        cfg.set_default(
            &format!("{}.mainnet.socks5_listener_address", app),
        ...
        cfg.set_default(
            &format!("{}.weatherwax.tcp_listener_address", app),
        ...
        cfg.set_default(
            &format!("{}.weatherwax.socks5_listener_address", app),
