...
INSERT INTO peers_new (peer_id, public_key, node_id, flags, banned_until, banned_reason, features, supported_protocols, added_at, user_agent, metadata, deleted_at)
