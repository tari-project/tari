...
impl NetAddressesWithStats {
    ...
    fn find_address_mut(&mut self, address: &Multiaddr) -> Option<&mut NetAddressWithStats> {
        self.addresses.iter_mut().find(|a| &a.net_address == address)
    }
...
impl From<Multiaddr> for NetAddressesWithStats {
...
impl From<Vec<Multiaddr>> for NetAddressesWithStats {
...
mod test {
    use super::*;
    use crate::connection::net_address::{
        net_address_with_stats::NetAddressWithStats,
