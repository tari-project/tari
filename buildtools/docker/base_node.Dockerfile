...
FROM quay.io/tarilabs/rust_tari-build-with-deps:nightly-2024-07-01 as builder
...
# RUN rustup component add rustfmt --toolchain nightly-2024-07-01-x86_64-unknown-linux-gnu
#ARG TBN_ARCH=native
ARG TBN_ARCH=x86-64
