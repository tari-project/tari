...
TARI_BASE=/var/tari/wallet
TARI_CONFIG=/var/tari/config
...
if [[ ! -f ${NETWORK}_console_wallet_id.json ]]; then
  echo "I could not find a network identity file for this node (${NETWORK}_console_wallet_id.json)."
