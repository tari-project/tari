...
impl SenderTransactionProtocol {
    ...
    pub fn builder(num_recipients: usize, transaction_weight: TransactionWeight) -> SenderTransactionInitializer {
        SenderTransactionInitializer::new(num_recipients, transaction_weight)
    }
