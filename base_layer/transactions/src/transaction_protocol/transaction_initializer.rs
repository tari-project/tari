...
use tari_consensus_encoding::ConsensusEncodingSized;
use tari_crypto::{
...
impl SenderTransactionInitializer {
    pub fn new(num_recipients: usize, transaction_weight: TransactionWeight) -> Self {
        Self {
            fee: Fee::new(transaction_weight),
            num_recipients,
