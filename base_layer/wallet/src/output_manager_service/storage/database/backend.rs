...
use crate::output_manager_service::{
    ...
    storage::{
        database::{DbKey, DbValue, StorageBackendQuery, WriteOperation},
...
pub trait OutputManagerBackend: Send + Sync + Clone {
    ...
    fn fetch_outputs_by(&self, q: StorageBackendQuery) -> Result<Vec<DbUnblindedOutput>, OutputManagerStorageError>;
}
