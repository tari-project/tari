-- SQLite cannot drop a column directly, so recreate the table without rejection_reason.
...
CREATE TABLE completed_transactions (
    ...
    transaction_signature_nonce BLOB    DEFAULT X'00'  NOT NULL,
    transaction_signature_key   BLOB    DEFAULT X'00'  NOT NULL,
