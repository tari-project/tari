...
ALTER TABLE pending_transaction_outputs ADD COLUMN coinbase_block_height BIGINT NULL;

ALTER TABLE completed_transactions ADD COLUMN coinbase_block_height BIGINT NULL;
