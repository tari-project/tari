-- Make lock_height nullable so it can be calculated on startup from transaction outputs.
-- NULL means "not yet calculated"; the wallet startup migration will compute the correct value.
