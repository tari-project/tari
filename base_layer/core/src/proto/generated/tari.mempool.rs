...
pub struct StateResponse {
    ...
    pub unconfirmed_pool: ::std::vec::Vec<super::types::Signature>,
    /// List of transactions in orphan pool.
    #[prost(message, repeated, tag = "2")]
    pub orphan_pool: ::std::vec::Vec<super::types::Signature>,
    /// List of transactions in pending pool.
    #[prost(message, repeated, tag = "3")]
    pub pending_pool: ::std::vec::Vec<super::types::Signature>,
    /// List of transactions in reorg pool.
    #[prost(message, repeated, tag = "4")]
    pub reorg_pool: ::std::vec::Vec<super::types::Signature>,
}
#[derive(Clone, PartialEq, ::prost::Message)]
