...
function createEnv(
  ...
  const configEnvs = {
    ...
    [`TARI_MERGE_MINING_PROXY__${network}__GRPC_BASE_NODE_ADDRESS`]: `/ip4/${baseNodeGrpcAddress}/tcp/${baseNodeGrpcPort}`,
    [`TARI_MERGE_MINING_PROXY__${network}__GRPC_CONSOLE_WALLET_ADDRESS`]: `/ip4/${walletGrpcAddress}/tcp/${walletGrpcPort}`,
