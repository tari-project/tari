...
Feature: Wallet FFI
    ...
    Scenario: As a client I want to be able to check my balance from restored wallets
        ...
        When mining node OTHER_MINER mines 5 blocks
        Then I stop wallet OTHER_WALLET
        When I wait for wallet MY_WALLET to have scanned to height 29
        ...
        When I wait for wallet MY_WALLET2 to have scanned to height 29
        ...
        When I wait for ffi wallet FFI_WALLET to have scanned to height 29
        Then I start TXO validation on ffi wallet FFI_WALLET
        ...
        When I wait for wallet VIEW_MY_WALLET to have scanned to height 29
    ...
    Scenario: As a client I want to cancel a transaction
        ...
        When mining node MINER mines 10 blocks
        Then ffi wallet FFI_WALLET detects AT_LEAST 1 ffi transactions to be TRANSACTION_STATUS_ONE_SIDED_UNCONFIRMED
    ...
    Scenario: As a client I want to retrieve a list of transactions I have made and received
        ...
        Then ffi wallet FFI_WALLET detects AT_LEAST 1 ffi transactions to be TRANSACTION_STATUS_ONE_SIDED_CONFIRMED
    ...
    Scenario: As a client I want to receive Tari via my Public Key sent while I am offline
        Given I have a seed node SEED
        ...
        And I send a one-sided stealth transaction of 1000000 uT from wallet SENDER to wallet FFI_WALLET at fee 5
        And I send a one-sided stealth transaction of 1000000 uT from wallet SENDER to wallet FFI_WALLET at fee 5
        Then wallet SENDER has at least 3 transactions that are all TRANSACTION_STATUS_BROADCAST and not cancelled
        When mining node MINER mines 10 blocks
    ...
    Scenario: As a client I want to send a one-sided transaction
        ...
        When mining node MINER mines 10 blocks
        Then all nodes are at height 20
        Then ffi wallet FFI_WALLET detects AT_LEAST 2 ffi transactions to be TRANSACTION_STATUS_ONE_SIDED_CONFIRMED
